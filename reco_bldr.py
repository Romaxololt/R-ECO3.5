...
def R_ECO3inf():
    return {
        ...
        "L2Module":    True,
        "manual": (
            "reco_bldr — Interactive builder for RSA+AES encrypted RCPKG1 packages  v1.5\n"
            "===========================================================================\n"
            "\n"
            "SYNOPSIS\n"
            "    reco_bldr\n"
            ...
            "COMMANDS\n"
            "    keygen\n"
            "        Generates a random RSA keypair in memory.\n"
            "\n"
            "    set_key\n"
            "        Derives a deterministic RSA keypair from a passphrase.\n"
            "\n"
            "    status\n"
            "        Displays the current key state, source folder, exclusions, and commands.\n"
            "\n"
            "    export_pubkey [path]\n"
            "        Exports the public key to pubkey.json or to the given path.\n"
            "\n"
            "    load_pubkey [path]\n"
            "        Loads a public key from a JSON file.\n"
            "\n"
            "    gen_default\n"
            "        Prints a snippet that can be pasted into R_ECO.py.\n"
            "\n"
            "    clear\n"
            "        Clears the keys currently stored in memory.\n"
            "\n"
            "    select [path]\n"
            "        Opens the folder browser and selects a source directory.\n"
            "\n"
            "    exclude [pattern]\n"
            "        Adds, lists, removes, or clears exclusion patterns.\n"
            "\n"
            "    command\n"
            "        Adds a command that will be embedded in the generated package.\n"
            "\n"
            "    pack\n"
            "        Builds an encrypted RCPKG1 package from the selected source.\n"
            "\n"
            "    list <paquet.reco>\n"
            "        Lists the content of a package without decrypting it.\n"
            "\n"
            "    verify <paquet.reco>\n"
            "        Verifies the integrity of a package with the public key.\n"
            "\n"
            "    help\n"
            "        Shows the REPL command list.\n"
            "\n"
            "EXAMPLES\n"
            "    reco_bldr\n"
            "    keygen\n"
