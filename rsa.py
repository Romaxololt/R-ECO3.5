...
def R_ECO3inf():
    return {
        ...
        "manual": (
            "rsa — Pure-Python RSA+AES+OAEP cryptographic primitives  v1.0\n"
            "=============================================================\n"
            "\n"
            "SYNOPSIS\n"
            "    rsa <command> [args...]\n"
            ...
            "\n"
            "    keygen [bits]\n"
            "        Generates a random RSA keypair. Defaults to 4096 bits.\n"
            "        Returns (n, e, d).\n"
            "\n"
            "    set_key <passphrase> [bits]\n"
            "        Derives a deterministic RSA keypair from a passphrase via PBKDF2-SHA256.\n"
            "        Same passphrase + same bits always produces the same keypair.\n"
            "        Returns (n, e, d).\n"
            "\n"
            "    encrypt <n> <d> <hex_data>\n"
            "        Hybrid RSA+AES-256-CBC encryption using the private key (n, d).\n"
            "        Returns the encrypted blob as hex.\n"
            "\n"
            "    decrypt <n> <e> <hex_blob>\n"
            "        Hybrid decryption using the public key (n, e).\n"
            "        Returns the plaintext as hex.\n"
            "\n"
            ...
            "EXAMPLES\n"
            "    rsa keygen 2048\n"
            "    rsa fingerprint 123456789\n"
            "    rsa set_key mypassphrase 4096\n"
            "    rsa encrypt 123 456 deadbeef\n"
            "    rsa decrypt 123 65537 00112233\n"
        ),
    }