...
def R_ECO3inf():
    return {
        ...
        "manual": (
            ...
            "  init\n"
            "    Interactively creates a new user account.\n"
            "    Prompts for a username and a confirmed password.\n"
            "    Stores hashed credentials in the RAVEN database.\n"
            "    Returns a session ID (sid) on success.\n"
            "    Takes no arguments.\n"
        )
    }